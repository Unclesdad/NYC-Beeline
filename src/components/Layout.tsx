...
interface LayoutProps {
  ...
  title?: string;
  description?: string;
  currentPage?: 'home' | 'about' | 'faqs' | 'routes';
}

export default function Layout({
  children,
  title = 'NYC Beeline - Smarter Inter-Borough Transit',
  description = 'Find the optimal route between boroughs in NYC using multiple transportation modes',
  currentPage = 'home',
}: LayoutProps) {
  return (
    <PageTransition>
